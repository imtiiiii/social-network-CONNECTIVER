			...
			<div class="_rightShimmer_all">
				...
				<div class="_rightShimmer" v-for="index in 13" :key="index">
					...
					<div class="_rightShimmer_details">
						<div
							class="_rightShimmer_name _shim_w90 _2shim_animate"
						></div>
					</div>
				</div>
			</div>
		...
		<template v-if="isloaded">
			<div class="_right_card _mar_b20">
				...
				<div class="_right_card_body _1scrollbar">
					<!-- Items -->
					<div
						class="_chat_list_card"
						v-for="(items, index) in 20"
						:key="index"
					>
						<div class="_chat_list_card_pic _active">
							<!-- changed here -->
							<img
								class="_chat_list_card_img"
						...
						<div class="_chat_list_card_details">
							<span class="_chat_list_card_name_main"
								><a href="" class="_chat_list_card_name"
									>Konstaintions Oikonomou</a
								></span
							>
						</div>
