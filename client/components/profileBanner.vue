				...
				<div class="_2banner_main">
					...
					<template v-if="isHide">
						<div class="_pro_shimmer">
							...
							<div
								class="_pro_shimmer_proPic _shim_animate"
							></div>
						...
						<div class="_2banner_menu">
							<div class="_2banner_menu_list">
								<ul class="_2banner_menu_list_ul">
									...
									<li
										:class="
											$route.path == '/profileAbout'
												? '_active'
												: ''
										"
									>
										<router-link to="/profileAbout"
											>About</router-link
										>
									</li>
									<li
										:class="
											$route.path == '/profileFriend'
												? '_active'
												: ''
										"
									>
										<router-link to="/profileFriend"
											>Friends</router-link
										>
									</li>
									<li
									...
									<li
										:class="
											$route.path == '/profileVideo'
												? '_active'
												: ''
										"
									>
										<router-link to="/profileVideo"
											>Videos</router-link
										>
									</li>
								</ul>
