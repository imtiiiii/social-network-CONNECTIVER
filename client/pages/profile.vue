					...
					<div class="_profile_right">
						...
						<template v-if="isHide">
							<div class="_proRight_shimmer _mar_b20">
								...
								<div
									class="
										_proRight_shimmer_des
										_shim_animate _shim_w90
									"
								></div>
								<div
									class="
										_proRight_shimmer_des
										_shim_animate _shim_w80
									"
								></div>
								<div
									class="
										_proRight_shimmer_des
										_shim_animate _shim_w40
									"
								></div>
								...
								<div class="_proRight_shimmer_items">
									<div
										class="
											_proRight_shimmer_items_img
											_shim_animate
										"
									></div>
									<div
										class="_proRight_shimmer_items_details"
									>
										<div
											class="
												_proRight_shimmer_items_title
												_shim_animate _shim_w50
											"
										></div>
									</div>
								</div>
						...
						<template v-if="isloaded">
							<div class="_proAbout_card _mar_b20">
								...
								<p class="_about_des _mar_b20">
									Welcome to Castaway On The Moon, A fortress
									of solitude for all things art and for
									creative enthusiasts. Got some hobbies
